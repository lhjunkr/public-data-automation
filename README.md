...
Gemini가 게시물 제목, 요약, 카테고리를 기준으로 게시물별 해시태그 4개를
생성합니다. 단, 운영 안정성을 위해 아래 조건을 통과한 경우에만 AI 생성 태그를
사용합니다.
...
AI 생성 태그가 조건을 통과하지 못하거나 Gemini API가 실패하면 아래 카테고리별
기본 태그로 되돌립니다.
...
- 설명문, 추천 대상, 수요 예측이 너무 길거나 위험 키워드가 포함되면 해당 AI
  섹션을 사용하지 않습니다.
